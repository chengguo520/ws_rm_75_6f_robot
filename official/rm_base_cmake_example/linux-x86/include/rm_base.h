...
/// \param arm_ip                   IP地址
/// \param arm_port                 端口号
/// \param dev_mode                 目标设备型号ARM_65/ARM_75/ARM_63
...
/// \param dMode   机械臂型号ARM_65 ARM_75 ARM_63
///
...
/// \param dev_mode     机械臂型号ARM_65 ARM_75 ARM_63
...
/// \return
///
RM_BASESHARED_EXPORT Pose Forward_Kinematics(int dev_mode, const float * joint);
...
///
RM_BASESHARED_EXPORT int inverse_kinematics(int dev_mode, const float *q_in, const Pose *q_pose, float *q_out,const uint8_t flag);
...
/// \param choose_axis
/// \return                             0-成功，失败返回:错误码, rm_define.h查询.
RM_BASESHARED_EXPORT Pose RotateMove(int dev_mode, float *Joint_Cur,int rotateAxis, float rotateAngle, Pose choose_axis);
...
/// \return                         工作坐标系下的位姿
///
RM_BASESHARED_EXPORT Pose Cartesian_Tool(float* Joint_Cur, int moveAxis, float movelength, int dev_mode);
#ifdef __cplusplus
}
#endif
#endif // RM_BASE_H
